...
export default function PaidAdsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <FAQSection 
        faqs={paidAdsFAQs}
        title="PPC Advertising FAQ"
        description="Get answers to common questions about our paid advertising services and how we can help maximize your advertising ROI."
      />
